...
is the Jacobean Determinant term. 
\begin{equation}
...
of $\epsilon_{0}$ and $\epsilon_{\ell}$ on the complex plane.This
Jacobean term is numerically computaed.
...
\hline 
m2  & 0.00178  & 0.00281 & 0.63\tabularnewline
\hline 
c2  & 2.978$*10^{-4}$  & 1.71{*}$10^{-4}$ & 1.74\tabularnewline
\hline 
\end{tabular}
