...
respectively, as $\epsilon$ = (a − b)/(a + b) exp(2i$\phi$). Due to the isotropic
...
sky patches simultaneously. With better knowledge on $\alpha$ we can in turn have better estimates on reduced shear g.
