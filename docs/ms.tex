...
acting on one all the galaxies in one sky patch.
...
\end{figure}
\begin{figure}
\includegraphics[scale=0.2]{fig/test10}
...
\begin{figure}
\includegraphics[scale=0.5]{fig/Np_step}

\includegraphics[scale=0.5]{fig/N16NP_vary}
...
lowwer panel shows the same thing with 16 galaxies in each patch. }
\end{figure}
