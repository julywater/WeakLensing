...
is a N dimension parameter to be infered, simultaneously with $g$.
...
The procedure of our simulation is as following. First we generated N$\times$NP
unlensed galaxies' elliprticity from the ``true'' $P(\epsilon_{0})$, and
asign these galaxies into NP patches equally. So each patch has N galaxies. Then
...
$\vec{g}$ of 64 sky patches in Figure 1. There are 8 galaxies in each patch in the simulation.
