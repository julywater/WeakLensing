...
bias of this Hierachical inference method.In principle given the correct model and prior ,
...
sets as described in section 4.1 .Each data set has 64 patches and 8$\times$64 galaxies,and
...
affect the variance and bias of this Hierarchy Bayesian method.As
mentioned before ,we only considers the catalog-level problem of how to combine galaxy ellipticity
measurements.Therefore we assume the likelihood of true lensed ellipticity $p(\epsilon_{ob}|\epsilon_{\ell})
is a 2D Gaussian with sigma equals 0.05 and mean equals true lensed ellipticity.
