...
We show the posterior samples of both $g$ and $\vec{\alpha}$, for both beta
...
In this section we calculate the mean square error of mean of posterior samples from the true(input) $g$.  We show the mean of posterior samples has smaller mean square error than the mean ellipticity estimator but has higher mean square error than the direct Bayesian estimates which could be made if we knew the exact intrinsic shape distribution.
...
affects the variance and bias shear inference.
