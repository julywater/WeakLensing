...
add on the true lensed ellipticity.We suppose there is a uniform shear
...
each lensing system - even though it has very large uncertainty- we
can calculate the statistical property like galaxy-mass correlation
