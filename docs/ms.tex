...
first step of weak lensing analysis, since it's the direct observable related with shear effect. However
...
. Insteadly, we can get the posterior distribution of mass profile for
...
of reduced shear $\vec{g}$ will  get closer to Gaussia, with larger number of galaxies used. When the number of galaxies in 
...
deviation as the most probable estimates and uncertainty. We will justify this approximation with a bias test in the following
sub section.
