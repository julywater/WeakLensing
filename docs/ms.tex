...
The Bayesian inference approach we proposed allows a natural way to optimally include all the data.What we need to do
is to propogate the whole likelihood of each lensing system while calculating the statistical properties of various lensing
systems.
